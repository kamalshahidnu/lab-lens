...
class GeminiSummarizer:
    ...
    def summarize(self, text: str, max_length: int = 150, system_prompt: Optional[str] = None) -> str:
        """
...
Summary:"""
    ...
    def batch_summarize(self, texts: List[str], max_length: int = 150, batch_size: int = 10, delay: float = 1.0) -> List[str]:
        """
    ...
    def answer_question(self, question: str, context: str, temperature: Optional[float] = None) -> str:
        """
