...
class ModelBiasDetector:
    ...
    def detect_bias(
        ...
        bias_report = {"total_samples": len(valid_df), "demographic_slices": {}, "overall_metrics": {}, "bias_alerts": []}
        ...
        for demo_col in demographic_columns:
            ...
            slice_results = self._analyze_slice(valid_df, demo_col, prediction_column, reference_column)
        ...
        bias_report["overall_bias_score"] = self._calculate_overall_bias_score(bias_report["demographic_slices"])

        logger.info(f"Bias detection completed. Found {len(bias_report['bias_alerts'])} alerts")
        return bias_report

    def _analyze_slice(
        self, df: pd.DataFrame, demographic_column: str, prediction_column: str, reference_column: str
    ) -> Dict[str, Any]:
        """
        ...
        """
        slice_results = {"groups": {}, "group_counts": {}, "metrics_by_group": {}}
    ...
    def _check_bias_alerts(self, slice_results: Dict[str, Any], demographic_column: str) -> List[Dict[str, Any]]:
        """
