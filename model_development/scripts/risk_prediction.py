...
class MedicalRiskPredictor:
    ...
    def extract_risk_factors(self, record: Dict) -> Dict:
        ...
        high_risk_count = sum(1 for condition in self.HIGH_RISK_CONDITIONS if condition in text or condition in diagnosis)
        medium_risk_count = sum(1 for condition in self.MEDIUM_RISK_CONDITIONS if condition in text or condition in diagnosis)
...
def main():
    ...
    parser.add_argument("--output", type=str, default="models/gemini/risk_predictions.csv", help="Output CSV file")
    parser.add_argument("--limit", type=int, default=None, help="Limit number of records")
    parser.add_argument("--use-gemini", action="store_true", help="Use Gemini for advanced risk prediction")
