...
Examples:
 ...
 python scripts/patient_qa_interactive.py --hadm-id 130656 --question "What are my medications?"
    ...
    parser.add_argument("--hadm-id", type=int, default=None, help="Hospital admission ID (filters to specific patient record)")

    parser.add_argument("--question", type=str, default=None, help="Single question to answer")

    parser.add_argument("--questions", type=str, nargs="+", default=None, help="Multiple questions to answer")
    ...
    try:
        qa_system = PatientQA(data_path=args.data_path, embedding_model=args.embedding_model, gemini_model=args.gemini_model)
