...
Examples:
 ...
 python scripts/test_rag_with_record.py --view-record 130656 --test 130656
    ...
    parser.add_argument("--list-records", action="store_true", help="List available HADM IDs")

    parser.add_argument("--view-record", type=int, help="View discharge summary for a specific HADM ID")

    parser.add_argument("--test", type=int, help="Test RAG system with a specific HADM ID")

    parser.add_argument("--questions", nargs="+", help="Custom questions to ask (use with --test)")
