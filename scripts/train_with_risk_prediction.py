...
def main():
    ...
    parser.add_argument("--output", type=str, default="models/gemini/summaries_with_risk.csv", help="Output CSV file")
    parser.add_argument("--limit", type=int, default=None, help="Limit number of records")
    parser.add_argument(
        "--use-gemini-risk", action="store_true", help="Use Gemini for risk prediction (slower but more accurate)"
    )

    args = parser.parse_args()

    process_with_risk_prediction(args.input, args.output, limit=args.limit, use_gemini_risk=args.use_gemini_risk)
