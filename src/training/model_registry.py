...
class ModelRegistry:
    ...
    def register_model_mlflow(self, run_id: str, model_name: str = "gemini-medical-summarization", stage: str = "None") -> str:
        """
    ...
    def push_to_gcp(self, model_path: str, model_version: str, model_metadata: Optional[Dict[str, Any]] = None) -> str:
        """
