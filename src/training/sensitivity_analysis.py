...
class SensitivityAnalyzer:
    ...
    def analyze_hyperparameter_sensitivity(
        self, optimization_history: pd.DataFrame, metric_column: str = "value"
    ) -> Dict[str, Any]:
        """
        ...
        results = {"hyperparameter_importance": {}, "correlations": {}, "sensitivity_plots": []}
    ...
    def analyze_feature_importance_shap(self, model, X: pd.DataFrame, sample_size: int = 100) -> Dict[str, Any]:
        """
    ...
    def _correlation_based_importance(self, X: pd.DataFrame) -> Dict[str, Any]:
        ...
        return {"feature_importance": importance, "top_features": list(importance.keys())[:10]}

    @safe_execute("analyze_text_importance_lime", logger, ErrorHandler(logger))
    def analyze_text_importance_lime(self, text: str, model_predict_fn: callable, num_features: int = 10) -> Dict[str, Any]:
        """
        ...
        # Explain prediction
        explanation = explainer.explain_instance(text, model_predict_fn, num_features=num_features)
    ...
    def create_sensitivity_plots(
        self, optimization_history: pd.DataFrame, output_dir: str = "logs/sensitivity_plots"
    ) -> List[str]:
        """
